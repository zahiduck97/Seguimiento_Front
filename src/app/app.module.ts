...
@NgModule({
  ...
  entryComponents: [
    ...
    ValidarTresComponent, AddUsuarioComponent, EditProspectComponent, EditNormaComponent, EditTipoServicioComponent, EditCostoComponent, AddCotizacionComponent, EditUsuarioComponent, EditPasswordComponent
  ],
